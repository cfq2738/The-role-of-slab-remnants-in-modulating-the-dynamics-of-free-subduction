...
# Side Plate Start
lat_sp = 11 # 622km from equator, 22km from edge of 1200km plate
...
# Blob Width
blob_width = 2400.0e3/d_nondim #full width

# Blob thickness
blob_thickness = 70.0e3/d_nondim # blob_thickness = plate thickness for a vertical case, blob length for a horizontal case

# Blob distance E/W from trench
blob_dist = 500.0e3/d_nondim

# Blob Top Depth
blob_top = 300.0e3/d_nondim

# Blob Bottom Depth
blob_bottom = 700.0e3/d_nondim
